...
\r
  ...
  tileset.style = new Cesium.Cesium3DTileStyle({\r
    color: {\r
      conditions: [\r
        ['\${height} >= 160.0 ', "color('rgb(240, 111, 93)', 1)"],\r
        ['\${height} >= 120.0 ', "color('rgb(20, 180, 180)', 1)"],\r
        ['\${height} >= 70.0 ', "color('rgb(30, 200, 93)', 1)"],\r
        ['\${height} >= 30.0 ', "color('rgb(180, 120, 120)', 1)"],\r
        ['true', "color('rgb(100, 200,200)',1)"]\r
      ]\r
    }\r
  })\r
